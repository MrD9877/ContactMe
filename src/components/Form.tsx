  ...
  return (
    <div>
      <form className="form">
        ...
        <button onClick={signInGoogle} className="oauthButton bg-white" type="button">
        ...
        {auth && auth.currentUser && (
          <>
            ...
            <button onClick={() => signOut(auth)} className="oauthButton bg-red-400 text-creamBackground" type="button">
              Logout
